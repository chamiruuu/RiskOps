...
export const VERSION_HISTORY_ITEMS = [
  ...
  },
  {
    ...
    date: "2026-05",
    notes:
      "Added SBO query policy confirmation gate to the ticket generator. And add '@' for Pragmatic Play for the script copy",
  },
  {
    version: "1.0.17",
    date: "2026-05",
  ...
  },
  {
    ...
    date: "2026-05",
    notes:
      "Fixed completed handover timestamps so updated_at refreshes on completion, and aligned the auto-sweeper and ticket visibility checks to GMT+8 comparisons.",
  },
  {
    version: "1.0.10",
    date: "2026-05",
